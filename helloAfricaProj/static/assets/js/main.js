...
const initSlider = () => {
    ...
    const slideButtons = document.querySelectorAll(".slider-wrapperrer .slide-button");
    const sliderScrollbar = document.querySelector(".collections .slider-scrollbar");
...
window.addEventListener('scroll', () => {
    ...
    if (window.scrollY > 600) {
        ...
        // Change the '0.8' value to set the desired opacity (from 0 to 1)
    }
});